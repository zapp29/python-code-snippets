...
from use_cases import PreorderTreeTravelrsal, InorderTreeTravelrsal, PostorderTreeTravelrsal
...
if __name__ == "__main__":
    Controller.get_tree_as_list(tree, PreorderTreeTravelrsal(NormalOrderPresenter()))
